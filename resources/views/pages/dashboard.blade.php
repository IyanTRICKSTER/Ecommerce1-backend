            ...
            <div class="card">
                <div class="card-body">
                    <div class="stat-widget-five">
                        ...
                        <div class="stat-content">
                            <div class="text-left dib">
                                <div class="stat-text"><span class="count">{{ $total_sold_product }}</span></div>
                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td> <span class="product">{{ $item->email }}</span> </td> --}}
                                        <td><span>{{ $item->phone }}</span></td>
                                        <td>
                                            @if ($item->transaction_status == 'PENDING')
                                            <span class="badge badge-pending">{{ $item->transaction_status }}</span>
